...
class KDTree
{
  ...
  private:
    ...
    //int partition(vector<Point<Dim>>& target, int left, int right, int k, int currDim);
    int quickselect(vector<Point<Dim>>& target, int left, int right, int m, int currDim);
    void buildtree(vector<Point<Dim>>& target, int left, int right, int dim);
    Point<Dim> findNeighborHelper(const Point<Dim>& query,Point<Dim> currentBest,int left,int right, int currDim) const;
    // Point<Dim> quickselect(vector<Point<Dim>>& target, int left, int right, int m, int currDim);
    int partition(vector<Point<Dim>>& target, int left, int right, int pivotIndex, int currDim);
    /**
